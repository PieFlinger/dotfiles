...
syn region cssEmbeddedPHP matchgroup=Delimiter start="<?\(=\|php\)\?" end="?>" keepend extend
syn region cssInlinePHP matchgroup=Delimiter start="<?\(=\|php\)\?" end="?>" keepend extend
...
syn region cssAttrBlock start=/:\zs/ end=/\ze[;}]\{1\}/ contained contains=cssAttr,cssColor,cssImportant,cssNumber,cssUnits,cssQuote,cssFunction,cssInlinePHP
...
HLink cssEmbeddedPHP Constant
HLink cssInlinePHP Constant
