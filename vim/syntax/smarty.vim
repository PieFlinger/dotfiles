" For version 5.x: Clear all syntax items For version 6.x: Quit when a syntax
...
syn region smartyZone           contained         matchgroup=Statement start="{"   end="}"        contains=smartyParameter, smartyProperty, smartyGlue, smartyModifier, smartyDollarSign, smartyInBracket, smartyStringDouble, smartyVariable, smartyString, smartyBlock, smartyTagName, smartyConstant, smartyInFunc
syn region smartyStringDouble   contained keepend matchgroup=Constant  start=+"+   end=+"+        contains=smartyMaybeVariable, smartyInBacktick, smartyMaybeDollarSign
...
syn region smartyParameter      contained keepend matchgroup=Statement start=+:+   end=+\s\|}+    contains=smartyVariable, smartyDollarSign, smartyGlue, smartyInBracket, smartyStringDouble
syn region smartyComment        contained         matchgroup=Comment   start="{\*" end="\*}"
